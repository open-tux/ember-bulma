...
export default Ember.Component.extend({
  ...
  tagName: 'section',
  classNames: ['hero'],
  classNameBindings: ['bold:is-bold', 'medium:is-medium', 'large:is-large', 'fullWidth:is-fullwidth', 'fullHeight:is-fullheight', 'isLeft:is-left', 'left:is-left', 'isRight:is-right', 'right:is-right'].concat(_colorBindings),
